...
// JUnitDoclet end extends_implements
{
    ...
    media.web.ImageViewer imageviewer = null;

    // JUnitDoclet end class

    public ImageViewerTest(String name) {
        // JUnitDoclet begin method ImageViewerTest
        super(name);
        // JUnitDoclet end method ImageViewerTest
    }

    public media.web.ImageViewer createInstance() throws Exception {
        // JUnitDoclet begin method testcase.createInstance
        return new media.web.ImageViewer();
    ...
    // JUnitDoclet begin method showImage
    // JUnitDoclet end method showImage
    }
    ...
    public static void main(String[] args) {
        ...
        junit.textui.TestRunner.run(ImageViewerTest.class);
