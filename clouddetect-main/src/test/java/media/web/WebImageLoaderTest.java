...
// JUnitDoclet end extends_implements
{
    ...
    media.web.WebImageLoader webimageloader = null;

    // JUnitDoclet end class

    public WebImageLoaderTest(String name) {
        // JUnitDoclet begin method WebImageLoaderTest
        super(name);
        // JUnitDoclet end method WebImageLoaderTest
    }

    public media.web.WebImageLoader createInstance() throws Exception {
        // JUnitDoclet begin method testcase.createInstance
        return new media.web.WebImageLoader();
    ...
    public static void main(String[] args) {
        ...
        junit.textui.TestRunner.run(WebImageLoaderTest.class);
