...
// JUnitDoclet end extends_implements
{
    ...
    public static TestSuite suite() {
        ...
        suite = new TestSuite("ui.handlers");

        suite.addTestSuite(ui.handlers.WebImageSettingsPanelHandlerTest.class);
        suite.addTestSuite(ui.handlers.WebcamSettingsPanelHandlerTest.class);
        suite.addTestSuite(ui.handlers.StatusHandlerTest.class);
        suite.addTestSuite(ui.handlers.ImagePanelHandlerTest.class);
