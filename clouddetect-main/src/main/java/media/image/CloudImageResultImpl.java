 ...
 */
public class CloudImageResultImpl implements CloudImageResult {
    private static Log log = LogFactory.getLog(CloudImageResultImpl.class);
    ...
    public CloudImageResultImpl(Image image) {
        if (image == null) {
    ...
    public CloudImageResultImpl(double[] data, int width, int height, boolean color) {
        setData(data, width, height, color);
    }

    public CloudImageResultImpl(int[] data, int width, int height, boolean color) {
