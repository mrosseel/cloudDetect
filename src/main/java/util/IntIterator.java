...
public interface IntIterator
{
   ...
   * @exception NoSuchElementException if no more elements can be retrieved.
   */
   ...
   * happen).
   *
   * @exception UnsupportedOperationException if the implementation does not
   * support removal of elements through the iterator.
   */
