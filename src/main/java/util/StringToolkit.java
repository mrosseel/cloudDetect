...
public class StringToolkit {
    /**
     * This method gives you the count of aSubstring in aString
     * <p>
     * e.g. <b> StringToolkit.getSubString("Select ? From ?","?") returns a
     * count of 2 </b>
     * 
     * @param aString
     *            the original string where we are looking for SubStrings.
     * @param aSubString
     *            the SubString to be retrieved in the aString
    ...
    /**
     * Returns a string containing the specified number of occurrences of the
     * specified string.
     * 
     * @param aString
     *            a <code>String</code> object.
     * @param aTimes
     *            an <code>int</code> object.
     * @return a string containing the specified number of occurrences of the
     *         specified string.
     */
     ...
     * This method gives you the count of aSubstring in aString
     * <p>
     * e.g. <b> StringToolkit.replaceSubString("Select ? From ?","?",
     * {"*","aTable"}) returns "Select * From aTable" </b>
     * 
     * @param aString
     *            the original string where we are replacing SubStrings.
     * @param aSubString
     *            the SubString to be replaced in the aString
     * @param aReplacementStrings
     *            is the list of String to replace the SubStrings
     * @return a String with the substring replaced by the list of replacement
     *         strings
     */
    public static String replaceSubString(String aString, String aSubString,
            String[] aReplacementStrings) {
        int startIndex = 0;
        int endIndex = 0;
     ...
     *            is a String to replace the SubStrings
     * @return a String with the substring replaced by the list of replacement
     *         strings
     */
    public static String replaceSubString(String aString, String aSubString,
        ...
        while ((startIndex = aString.indexOf(aSubString)) != -1) {
            ...
            tempResult = tempResult
                    + stringBuffer.toString().substring(0,
                            startIndex + aReplacementString.length());
            stringBuffer = new StringBuffer(stringBuffer.toString().substring(
                    startIndex + aReplacementString.length()));
            aString = stringBuffer.toString();
        }

        // add the last piece of the Stringbuffer which do not conatin any
        // substrings anymore
    ...
    /**
     * This method adds padding (white spaces) to a String until it has reached
     * a certain length. This is useful when you want to have fixed-width
     * columns.<br>
     * If the String exceeds the given length, it is returned as is.
     * 
     * @param aString
     *            the original string you want to pad.
     * @param aLength
     *            the length up to which you want to pad.
    ...
    /**
     * This method allows you to extract substrings from a string formatted
     * using a separator.
     * 
     * @param aString
     *            the original string
